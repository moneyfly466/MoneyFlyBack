...
public class Comercio {
    ...
    @Column(name = "actividad", nullable = false, length = 30)
    private String actividad;

    @Column(name = "contacto", nullable = true, length = 30)
    private String contacto;

    @Column(name = "total_gastado", nullable = false)
    private int totalGastado;

    @Column(name = "ubicacion", nullable = true, length = 30)
    private String ubicacion;

    @Column(name = "gasto_promedio", nullable = false)
    private int gastoPromedio;

    @Column(name = "sector_comercial", nullable = false, length = 30)
    ...
    public Comercio(int id, String nit, String nombre, String actividad, String contacto,
                    int totalGastado, String ubicacion, int gastoPromedio, String sectorComercial,
